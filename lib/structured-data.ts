...
export function getOrganizationSchema(): OrganizationSchema {
  return {
    ...
    logo: "https://rta.arwindpianist.com/images/newlogo.png",
    description: "RTA Services provides third-party hardware and software maintenance, open source software (OSS) support, and professional services across Asia-Pacific.",
    address: {
      "@type": "PostalAddress",
...
export function getLocalBusinessSchema(): LocalBusinessSchema {
  return {
    ...
    "@type": "LocalBusiness",
    name: "RTA Services",
    image: "https://rta.arwindpianist.com/images/newlogo.png",
